...
class People2 extends StatefulWidget {
  const People2({super.key});

  @override
  State<People2> createState() => _People2State();
}

class _People2State extends State<People2> {
  bool _issaved = false;
  @override
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Peoplesetting2()),
                          );
                        },
