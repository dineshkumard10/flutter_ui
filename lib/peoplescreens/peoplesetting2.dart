...
class Peoplesetting2 extends StatefulWidget {
  const Peoplesetting2({super.key});

  @override
  State<Peoplesetting2> createState() => _Peoplesetting2State();
}

class _Peoplesetting2State extends State<Peoplesetting2> {
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Padding(
                        ...
                        child: Text('Alex Saveau',
                            style: RobotoFont().T_TextTitle),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(top: 8, left: 12),
                        child: Text('AlexSaveau@gmail.com',
