...
class People1 extends StatefulWidget {
  const People1({super.key});

  @override
  State<People1> createState() => _People1State();
}

class _People1State extends State<People1> {
  bool _issaved = false;
  @override
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Peoplesetting1()),
                          );
                        },
