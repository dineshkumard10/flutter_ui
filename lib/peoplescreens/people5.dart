...
class People5 extends StatefulWidget {
  const People5({super.key});

  @override
  State<People5> createState() => _People5State();
}

class _People5State extends State<People5> {
  bool _issaved = false;
  @override
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Peoplesetting5()),
                          );
                        },
