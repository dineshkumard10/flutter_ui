...
class People4 extends StatefulWidget {
  const People4({super.key});

  @override
  State<People4> createState() => _People4State();
}

class _People4State extends State<People4> {
  bool _issaved = false;
  @override
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Peoplesetting4()),
                          );
                        },
