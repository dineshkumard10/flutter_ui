...
import '../screens/textsearch.dart';
...
class Peoplesetting3 extends StatefulWidget {
  const Peoplesetting3({super.key});

  @override
  State<Peoplesetting3> createState() => _Peoplesetting3State();
}

class _Peoplesetting3State extends State<Peoplesetting3> {
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Padding(
                        ...
                        child:
                            Text('Alex Vanyo', style: RobotoFont().T_TextTitle),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(top: 8, left: 12),
                        child: Text('Alexvanyo@gmail.com',
