...
class Peoplesetting5 extends StatefulWidget {
  const Peoplesetting5({super.key});

  @override
  State<Peoplesetting5> createState() => _Peoplesetting5State();
}

class _Peoplesetting5State extends State<Peoplesetting5> {
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Padding(
                        ...
                        child: Text('Andew Flynn',
                            style: RobotoFont().T_TextTitle),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(top: 8, left: 12),
                        child: Text('AndewFlynn@gmail.com',
