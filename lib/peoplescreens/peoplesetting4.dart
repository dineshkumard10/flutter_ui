...
class Peoplesetting4 extends StatefulWidget {
  const Peoplesetting4({super.key});

  @override
  State<Peoplesetting4> createState() => _Peoplesetting4State();
}

class _Peoplesetting4State extends State<Peoplesetting4> {
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Padding(
                        ...
                        child: Text('Amanda Alexander',
                            style: RobotoFont().T_TextTitle),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(top: 8, left: 12),
                        child: Text('AmandaAlexander@gmail.com',
